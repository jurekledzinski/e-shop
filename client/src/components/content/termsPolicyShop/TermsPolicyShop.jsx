  ...
  return (
    <section>
      <div className="terms-shop">
        ...
        <p className="terms-shop__text">Welcome to courseshop!</p>

        <p className="terms-shop__text">
        ...
        <h3 className="terms-shop__subtitle">
          <strong className="terms-shop__subtitle-strong">Cookies</strong>
        </h3>
        ...
        <h3 className="terms-shop__subtitle">
          <strong className="terms-shop__subtitle-strong">License</strong>
        </h3>
        ...
        <p className="terms-shop__text">
          ...
          courseshop for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p className="terms-shop__text">You must not:</p>
        <ul className="terms-shop__list">
          <li className="terms-shop__item">
        ...
        <p className="terms-shop__text">
          ...
          Courseshop does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Courseshop,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Courseshop shall
        ...
        <p className="terms-shop__text">You warrant and represent that:</p>
        ...
        <p className="terms-shop__text">
          You hereby grant Courseshop a non-exclusive license to use, reproduce,
          edit and authorize others to use, reproduce and edit any of your
          Comments in any and all forms, formats or media.
        </p>

        <h3 className="terms-shop__subtitle">
          <strong className="terms-shop__subtitle-strong">
        ...
        <ul className="terms-shop__list">
          <li className="terms-shop__item">Government agencies;</li>
          <li className="terms-shop__item">Search engines;</li>
          <li className="terms-shop__item">News organizations;</li>
          <li className="terms-shop__item">
        ...
        <ul className="terms-shop__list">
          ...
          <li className="terms-shop__item">dot.com community sites;</li>
          <li className="terms-shop__item">
            associations or other groups representing charities;
          </li>
          <li className="terms-shop__item">online directory distributors;</li>
          <li className="terms-shop__item">internet portals;</li>
          <li className="terms-shop__item">
        ...
        <p className="terms-shop__text">
          ...
          the hyperlink compensates the absence of Courseshop; and (d) the link
        ...
        <ul className="terms-shop__list">
          <li className="terms-shop__item">By use of our corporate name; or</li>
          <li className="terms-shop__item">
        ...
        <h3 className="terms-shop__subtitle">
          <strong className="terms-shop__subtitle-strong">iFrames</strong>
        </h3>
        ...
        <h3 className="terms-shop__subtitle">
          <strong className="terms-shop__subtitle-strong">Your Privacy</strong>
        </h3>

        <p className="terms-shop__text">Please read Privacy Policy</p>
        ...
        <h3 className="terms-shop__subtitle">
          <strong className="terms-shop__subtitle-strong">Disclaimer</strong>
        </h3>
...
export default TermsPolicyShop;
